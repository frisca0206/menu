            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= url_to('sewa_film-store')?>" method="POST">
                                <?= csrf_field() ?>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="nama_film" name="nama_film" class="form-control">
                                                ...
                                                <option value="<?= $film['nama_film']; ?>"><?= $film['nama_film']; ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="durasi_jam">Durasi</label>
